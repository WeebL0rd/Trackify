...
// usando @stellar/stellar-sdk directamente.
...
async function anclarEnStellar(hash) {
  if (!hash || hash.length !== 64) {
    throw new Error(
      "[anclarEnStellar] Hash inválido — debe ser SHA-256 hex de 64 caracteres",
    );
  }
  ...
  console.log(
    "[anclarEnStellar] Cargando account desde Horizon:",
    keypair.publicKey(),
  );
  ...
  console.log(
    "[anclarEnStellar] Respuesta Horizon:",
    JSON.stringify(
      {
  ...
  console.log(
    "[anclarEnStellar] Resultado final:",
